...
<form action="Slogin" id="login" class="input-grp" method="post">
...
<form id="sign" class="input-grp" action="Regstu" method="post">
...
<input type="text" class="input-field" placeholder="Course" required id="course" name="course">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="text" class="input-field" placeholder="Branch" required id="branch" name="branch"></br>
<input type="text" class="input-field" placeholder="year" required id="year" name="year">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="text" class="input-field" placeholder="City" required id="city" name="city"></br>

</br>
<button type="submit" class="submit-btn"  onclick="return Validate()" >Sign up</button>
</form>
</div>
</div>
</div>
