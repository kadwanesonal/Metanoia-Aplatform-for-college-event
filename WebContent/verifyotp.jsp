...
<div class="form-box" style="width:500px; height:200px; top:200px; padding:40px;overflow:hidden;
border:solid;
border-color:black;position:relative;
margin:6% auto;
background:#fff">
<form action="checkotp.jsp" method="post">
<input style="width:250px" type="number" class="input-field" placeholder="Enter OTP" required name="ot">
</br></br>
